...
CREATE TABLE IF NOT EXISTS `mybusiness_payroll_tax` (
  `id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mybusiness_payroll_grade_comp` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `job_name` VARCHAR(50) NOT NULL,
  `grade_level` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mybusiness_payroll_employee_comp` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `job_name` VARCHAR(50) NOT NULL,
  `citizenid` VARCHAR(50) NOT NULL,
  `hourly_rate` DECIMAL(10,2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mybusiness_payroll_employee_bonus` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `job_name` VARCHAR(50) NOT NULL,
  `citizenid` VARCHAR(50) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_bonus_job_status` (`job_name`,`status`),
  KEY `idx_bonus_citizen` (`citizenid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
